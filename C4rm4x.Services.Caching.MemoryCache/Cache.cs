...
using C4rm4x.Services.Framework.Caching;
using System;
...
namespace C4rm4x.Services.Caching.MemoryCache
{
    /// <summary>
    ...
    public class Cache : ICache
    {
        ...
        public Task StoreAsync<T>(string key, T objectToStore, int expirationTime = 60)
        {
